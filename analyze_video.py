...
if __name__ == "__main__":
    ...
    parser.add_argument("--segment-duration", type=float, default=30.0, help="Length of video segments in seconds (default: 30.0)")
    parser.add_argument("--transcription-path", help="Path to a JSON file containing speech transcription")
    parser.add_argument("--use-speech-based-segments", action="store_true", help="Use speech-based segmentation instead of fixed intervals")
